...
public class JTetris extends JComponent {
	...
	JTetris(int pixels) {
		...
		*/
		...
		registerKeyboardAction(
			...
			}, "rotate", KeyStroke.getKeyStroke('8'), WHEN_IN_FOCUSED_WINDOW
		);
		registerKeyboardAction(
			new ActionListener() {
				public void actionPerformed(ActionEvent e) {
	...
	*/
	...
	public void paintComponent(Graphics g) {
		...
		Image bg = new ImageIcon("Tetris_Cover.PNG").getImage();
		g.drawImage(bg,0,0,360,580,null );
	...
	*/
	...
	public static JFrame creatFrame(JTetris tetris){
		JFrame frame = new JFrame("Tetris Game");
		ImageIcon image = new ImageIcon("tetris.JPG");
		...
		controls.add(quit,BorderLayout.CENTER);
	...
	*/
	...
	{
		JTetris tetris = new JTetris(24);
		JFrame frame = JTetris.creatFrame(tetris);
